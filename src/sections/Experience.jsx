const experiences = [
...

    {
        ...
        description: "Developed a Java-based internal application using JavaFX for the UI and server sockets for real-time data processing to automate employee hour, overtime, and break calculations, replacing manual spreadsheet workflows.",
...

    {
        ...
        description: "Completed full-stack development training covering frontend applications, backend APIs, and database integration using modern development tools.",
